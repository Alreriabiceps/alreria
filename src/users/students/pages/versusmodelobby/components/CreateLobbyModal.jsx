        ...
        <div className={styles.modalContent}>
          {hasActiveLobby ? (
            <div className={styles.infoMessage}>
              <p><FaExclamationTriangle style={{ color: '#FFB347', marginRight: 6 }} /> You already have an active lobby. Please wait for it to expire before creating a new one.</p>
            </div>
          ) : (
            <>
              {!form.isPrivate ? (
                <div className={styles.infoMessage}>
                  <p><FaExclamationTriangle style={{ color: '#FFB347', marginRight: 6 }} /> Open lobbies expire after 3 minutes. You can only have one active lobby at a time.</p>
                  <p>Click "Create Lobby" to proceed.</p>
                </div>
              ) : (
                <>
                  <div className={styles.infoMessage}>
                    <p><FaExclamationTriangle style={{ color: '#FFB347', marginRight: 6 }} /> Private lobbies expire after 3 minutes. You can only have one active lobby at a time.</p>
                  </div>
