...
// Bloom's Rarity Configuration (for frontend card selection)
export const BLOOM_RARITY = {
...
export const SPELL_CARDS_CONFIG = {
  chain_lightning: {
...
// Power-ups Configuration (placeholder - not currently implemented)
export const POWERUPS_CONFIG = {
  // This is a placeholder configuration
  // Power-ups are not currently implemented in the game
  // but the component exists for future use
};
